    ...
    <body>
		...
		<?php include("header.php"); ?>
       	<div class="container">
			...
			<?php 
                ...
                echo "<h1 style='font-size:24px; color:#805422;'>All Submitted Transactions Details</h1><br />";
                // display data in table
                echo "<table id='rounded-corner'>";
                echo "<tr><th>Transaction Id</th><th>Customer Id</th><th>Authorize.net Transaction Id</th></tr>";
                ...
                for ($i = $start; $i < $end; $i++)
                {
                        ...
                        echo "<tr>";
						echo '<td>' . mysql_result($result, $i, 'transaction_id') . '</td>';
                        echo '<td>' . mysql_result($result, $i, 'customer_id') . '</td>';
                        echo '<td>' . mysql_result($result, $i, 'last_trans_id') . '</td>';
		...
		<div style="text-align:center;">
			<?php
                    ...
                    {	                        
                        echo "<a href='transaction_details.php?page=$i'><b style='color:#805422;word-spacing:5px;'>$i</b></a> ";
                    }
                    echo "</p>";
            ?>   
       </div>             
